...
#if !defined(MIMXRT1024_COMMON_H_)
#define MIMXRT1024_COMMON_H_                     /**< Symbol preventing repeated inclusion */
...
#include "system_MIMXRT1024.h"         /* Device specific configuration file */
