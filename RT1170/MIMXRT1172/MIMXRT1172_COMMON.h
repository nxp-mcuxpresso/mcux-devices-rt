...
#if !defined(MIMXRT1172_COMMON_H_)
#define MIMXRT1172_COMMON_H_                     /**< Symbol preventing repeated inclusion */
...
#include "system_MIMXRT1172.h"         /* Device specific configuration file */
