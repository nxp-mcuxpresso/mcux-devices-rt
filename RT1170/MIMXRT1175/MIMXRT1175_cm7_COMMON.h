...
#if !defined(MIMXRT1175_CM7_COMMON_H_)
#define MIMXRT1175_CM7_COMMON_H_                 /**< Symbol preventing repeated inclusion */
...
#include "system_MIMXRT1175_cm7.h"     /* Device specific configuration file */
