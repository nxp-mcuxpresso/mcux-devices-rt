...
#if !defined(MIMXRT1165_CM7_COMMON_H_)
#define MIMXRT1165_CM7_COMMON_H_                 /**< Symbol preventing repeated inclusion */
...
#include "system_MIMXRT1165_cm7.h"     /* Device specific configuration file */
...
#define FlexSPI_AMBA_BASE_ARRAY                  { {0x30000000u}, {0x60000000u} }
/* FlexSPI AMBA end address array. */
#define FlexSPI_AMBA_END_ARRAY                   { {0x3FFFFFFFu}, {0x7F7FFFFFu} }
...
#endif  /* MIMXRT1165_CM7_COMMON_H_ */
