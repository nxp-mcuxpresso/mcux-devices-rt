...
#if !defined(MIMXRT1041_COMMON_H_)
#define MIMXRT1041_COMMON_H_                     /**< Symbol preventing repeated inclusion */
...
#include "system_MIMXRT1041.h"         /* Device specific configuration file */
