 ...
 * @version 0.1
 * @date 2021-07-20
 * @brief Device specific configuration file for MIMXRT1046 (header file)
 *
...
#ifndef _SYSTEM_MIMXRT1046_H_
#define _SYSTEM_MIMXRT1046_H_                    /**< Symbol preventing repeated inclusion */
