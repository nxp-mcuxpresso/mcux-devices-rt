 ...
 * @version 1.0
 * @date 2025-03-10
 * @brief Device specific configuration file for MIMXRT1181 (header file)
 *
...
#ifndef _SYSTEM_MIMXRT1181_H_
#define _SYSTEM_MIMXRT1181_H_                    /**< Symbol preventing repeated inclusion */
