 ...
 * @version 1.0
 * @date 2025-03-31
 * @brief Device specific configuration file for MIMXRT1182 (header file)
 *
...
#ifndef _SYSTEM_MIMXRT1182_H_
#define _SYSTEM_MIMXRT1182_H_                    /**< Symbol preventing repeated inclusion */
