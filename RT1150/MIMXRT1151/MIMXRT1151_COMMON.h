...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MIMXRT1151
**
...
/*!
 * @file MIMXRT1151_COMMON.h
 * @version 0.2
 * @date 2026-02-26
 * @brief CMSIS Peripheral Access Layer for MIMXRT1151
 *
 * CMSIS Peripheral Access Layer for MIMXRT1151
 */

#if !defined(MIMXRT1151_COMMON_H_)
#define MIMXRT1151_COMMON_H_                     /**< Symbol preventing repeated inclusion */
...
#include "system_MIMXRT1151.h"         /* Device specific configuration file */
...
#ifndef MIMXRT1151_SERIES
#define MIMXRT1151_SERIES
#endif
/* CPU specific feature definitions */
#include "MIMXRT1151_features.h"
...
#define CAN_WRAPPER_BASE_ADDRS                   { 0u, CAN1_WRAPPER_BASE, CAN2_WRAPPER_BASE }
/** Array initializer of CAN_WRAPPER peripheral base pointers */
#define CAN_WRAPPER_BASE_PTRS                    { (CAN_WRAPPER_Type *)0u, CAN1_WRAPPER, CAN2_WRAPPER }
...
#define ENET_BASE_ADDRS                          { 0u, ENET_1G_BASE }
/** Array initializer of ENET peripheral base pointers */
#define ENET_BASE_PTRS                           { (ENET_Type *)0u, ENET_1G }
/** Interrupt vectors for the ENET peripheral type */
#define ENET_Transmit_IRQS                       { NotAvail_IRQn, ENET_1G_IRQn }
#define ENET_Receive_IRQS                        { NotAvail_IRQn, ENET_1G_IRQn }
#define ENET_Error_IRQS                          { NotAvail_IRQn, ENET_1G_IRQn }
#define ENET_1588_Timer_IRQS                     { NotAvail_IRQn, ENET_1G_1588_Timer_IRQn }
#define ENET_Ts_IRQS                             { NotAvail_IRQn, ENET_1G_IRQn }
...
#define LPI2C_BASE_ADDRS                         { 0u, LPI2C1_BASE, LPI2C2_BASE, LPI2C3_BASE, LPI2C4_BASE, 0u, LPI2C6_BASE }
/** Array initializer of LPI2C peripheral base pointers */
#define LPI2C_BASE_PTRS                          { (LPI2C_Type *)0u, LPI2C1, LPI2C2, LPI2C3, LPI2C4, (LPI2C_Type *)0u, LPI2C6 }
/** Interrupt vectors for the LPI2C peripheral type */
#define LPI2C_IRQS                               { NotAvail_IRQn, LPI2C1_IRQn, LPI2C2_IRQn, LPI2C3_IRQn, LPI2C4_IRQn, NotAvail_IRQn, LPI2C6_IRQn }
...
#define LPSPI_BASE_ADDRS                         { 0u, LPSPI1_BASE, LPSPI2_BASE, LPSPI3_BASE, LPSPI4_BASE, LPSPI5_BASE }
/** Array initializer of LPSPI peripheral base pointers */
#define LPSPI_BASE_PTRS                          { (LPSPI_Type *)0u, LPSPI1, LPSPI2, LPSPI3, LPSPI4, LPSPI5 }
/** Interrupt vectors for the LPSPI peripheral type */
#define LPSPI_IRQS                               { NotAvail_IRQn, LPSPI1_IRQn, LPSPI2_IRQn, LPSPI3_IRQn, LPSPI4_IRQn, LPSPI5_IRQn }
...
#define LPUART_BASE_ADDRS                        { 0u, LPUART1_BASE, LPUART2_BASE, LPUART3_BASE, 0u, LPUART5_BASE, LPUART6_BASE, LPUART7_BASE, LPUART8_BASE, LPUART9_BASE, 0u, 0u, LPUART12_BASE }
/** Array initializer of LPUART peripheral base pointers */
#define LPUART_BASE_PTRS                         { (LPUART_Type *)0u, LPUART1, LPUART2, LPUART3, (LPUART_Type *)0u, LPUART5, LPUART6, LPUART7, LPUART8, LPUART9, (LPUART_Type *)0u, (LPUART_Type *)0u, LPUART12 }
/** Interrupt vectors for the LPUART peripheral type */
#define LPUART_RX_TX_IRQS                        { NotAvail_IRQn, LPUART1_IRQn, LPUART2_IRQn, LPUART3_IRQn, NotAvail_IRQn, LPUART5_IRQn, LPUART6_IRQn, LPUART7_IRQn, LPUART8_IRQn, LPUART9_IRQn, NotAvail_IRQn, NotAvail_IRQn, LPUART12_IRQn }
...
#define RTWDOG_BASE_ADDRS                        { 0u, 0u, 0u, RTWDOG3_BASE }
/** Array initializer of RTWDOG peripheral base pointers */
#define RTWDOG_BASE_PTRS                         { (RTWDOG_Type *)0u, (RTWDOG_Type *)0u, (RTWDOG_Type *)0u, RTWDOG3 }
/** Interrupt vectors for the RTWDOG peripheral type */
#define RTWDOG_IRQS                              { NotAvail_IRQn, NotAvail_IRQn, NotAvail_IRQn, RTWDOG3_IRQn }
/* Extra definition */
