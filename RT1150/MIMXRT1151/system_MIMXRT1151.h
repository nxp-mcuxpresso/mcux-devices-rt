 ...
 * @version 1.0
 * @date 2026-02-26
 * @brief Device specific configuration file for MIMXRT1151 (header file)
 *
...
#ifndef _SYSTEM_MIMXRT1151_H_
#define _SYSTEM_MIMXRT1151_H_                    /**< Symbol preventing repeated inclusion */
