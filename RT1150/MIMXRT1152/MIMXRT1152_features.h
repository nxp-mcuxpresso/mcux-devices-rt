...
**         Initial version.
**     - rev. 0.2 (2026-02-26)
**         Update feature file based on RM Rev1.
**
** ###################################################################
*/

#ifndef _MIMXRT1152_FEATURES_H_
#define _MIMXRT1152_FEATURES_H_
...
#define FSL_FEATURE_SOC_LPSPI_COUNT (5)
/* @brief LPUART availability on the SoC. */
#define FSL_FEATURE_SOC_LPUART_COUNT (9)
